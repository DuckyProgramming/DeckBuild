class group{
    ...
    updateHand(){
        for(e=0,le=this.cards.length;e<le;e++){
            ...
            if(this.cards[e].position.x>e*80+126&&(this.cards[e].position.x>this.cards[max(0,e-1)].position.x+80&&this.battle.player!=6||this.cards[e].position.x>this.cards[max(0,e-1)].position.x+140&&this.battle.player==6||e==0)){
