    ...
    initial(type){
        ...
        switch(type){
            ...
            case 3:
                ...
                this.add(342,0,this.battle.player)
                this.add(343,0,this.battle.player)
                this.add(344,0,this.battle.player)
                this.add(345,0,this.battle.player)
                this.add(346,0,this.battle.player)
            break
            case 4:
                for(e=0;e<4;e++){
                    this.add(1,0,this.battle.player)
            ...
            case 6:
                ...
                /*this.add(638,0,this.battle.player)
                this.add(639,0,this.battle.player)
                this.add(640,0,this.battle.player)
                this.add(641,0,this.battle.player)
