...
function displayIntent(layer,x,y,fade,size,damage,alt,type){
	...
	switch(type){
		...
		break
		case 2: case 4: case 5: case 48: case 49: case 50: case 51: case 52: case 53:
		...
		break
		case 8: case 16: case 22: case 23: case 25: case 29:
		...
		case 26:
			layer.fill(150,175,200,fade*3/4)
			layer.triangle(12,-5,4,-5,4,-9)
			layer.triangle(-12,-5,-4,-5,-4,-9)
			layer.arc(4,-5,16,28,0,90)
			layer.arc(-4,-5,16,28,90,180)
		break
		case 27:
			layer.fill(200,fade*3/4)
			layer.triangle(-5,6,5,6,0,-10)
		break
		case 28:
			layer.fill(255,50,50,fade*3/4)
			layer.triangle(0,0,-15,-9,-9,-15)
		...
		break
		case 31:
			layer.fill(255,255,0,fade*3/4)
			layer.ellipse(0,0,15,15)
			layer.fill(255,50,50,fade*3/4)
			layer.triangle(-20,0,15,-6,15,6)
		break
		case 32:
			layer.fill(255,fade*3/4)
			layer.rect(-6,0,24,6)
	...
	switch(type){
		...
		case 26: case 27: case 28: case 29: case 30: case 33: case 38: case 39: case 40: case 47:
		...
		break
		case 9: case 14: case 15: case 17: case 22: case 23: case 31: case 34:
			layer.textSize(16)
...
function outEvent(){
	...
	'\n'+types.combatant[6].name+': '+zones[0].events[6].length+
	'\nTotal: '+(zones[0].events[0].length+zones[0].events[1].length+zones[0].events[2].length+zones[0].events[3].length+zones[0].events[4].length+zones[0].events[5].length+zones[0].events[6].length))
}
...
function displayRelicSymbol(layer,x,y,type,direction,size,flip,active){
	...
	switch(type){
		...
		break
		case 167:
			layer.image(graphics.symbol[14],-18,-10,20,20)
			layer.image(graphics.symbol[13],-16,-8,16,16)
			layer.image(graphics.symbol[7],0,-10,20,20)
			layer.image(graphics.symbol[15],2,-8,16,16)
		break
		case 168:
			layer.text('4',8,6)
			layer.image(graphics.symbol[25],-10,-20,20,20)
			layer.image(graphics.symbol[4],-16,-2,16,16)
		break
		case 169:
			layer.textSize(10)
			layer.text('W',-10,0)
			layer.image(graphics.symbol[28],-20,-10,20,20)
			layer.image(graphics.symbol[7],0,-10,20,20)
			layer.image(graphics.symbol[15],2,-8,16,16)
		break
		case 170:
		...
		break
		case 171:
			layer.image(graphics.symbol[15],-22,-10,20,20)
			layer.text('$10',6,1)
		break
		case 172:
			layer.textSize(10)
		...
		case 175:
			layer.textSize(10)
			layer.text('5',0,12)
			layer.image(graphics.symbol[47],-16,-16,20,20)
			layer.image(graphics.symbol[15],0,-16,20,20)
		break
		case 176:
			layer.textSize(10)
			layer.text('1',-8,-6)
			layer.text('-',8,-6)
			layer.text('7',0,10)
			layer.image(graphics.symbol[5],-16,-14,16,16)
			layer.image(graphics.symbol[5],0,-14,16,16)
			layer.image(graphics.symbol[5],-8,2,16,16)
		break
		case 177:
			layer.textSize(10)
			layer.text('+2',0,12)
			layer.image(graphics.symbol[14],-18,-14,20,20)
			layer.image(graphics.symbol[2],-16,-12,16,16)
			layer.image(graphics.symbol[7],2,-12,16,16)
		break
		case 178:
			layer.text('1',10,1)
			layer.textSize(10)
			layer.text('E',-4,-4)
			layer.text('M',-4,4)
			layer.image(graphics.symbol[5],-16,-12,24,24)
		break
		case 179:
			layer.textSize(10)
			layer.text('E',-4,0)
			layer.text('1',12,0)
			layer.image(graphics.symbol[5],-14,-10,20,20)
			layer.image(graphics.symbol[14],-16,-12,24,24)
		break
		case 180:
			layer.textSize(10)
			layer.text('E',0,-6)
			layer.text('R',0,6)
			layer.image(graphics.symbol[5],-16,-16,32,32)
		break
		case 181:
			layer.textSize(10)
			layer.text('1',8,0)
			layer.image(graphics.symbol[5],-18,-10,20,20)
			layer.image(graphics.symbol[5],-2,-10,20,20)
			layer.image(graphics.symbol[47],-14,-6,12,12)
		break
		case 182:
			layer.textSize(10)
			layer.text('1',9,0)
			layer.text('E',-7,-4)
			layer.text('M',-7,4)
			layer.image(graphics.symbol[5],-1,-10,20,20)
			layer.image(graphics.symbol[5],-19,-12,24,24)
		break
	}
